...
| <img src="https://github.com/baisebaoma/baisebaoma/blob/main/changjun-logo.png?raw=true" alt="Changjun High School" width="100" /> | <img src="https://github.com/baisebaoma/baisebaoma/blob/main/UoN-Nottingham-Blue.png?raw=true" alt="Nottingham" width="100" /> | <img src="https://github.com/baisebaoma/baisebaoma/blob/main/gatech-color_logo.png?raw=true" alt="Georgia Tech" width="100" /> |
| :---: | :---: | :---: |

</div>

# 👋🏻 Hi there, I'm baisebaoma!
...
我非常自豪能通过代码帮助到他人，无论是科研人员还是学生：

* 🕷️ **[baiduqianxi](https://github.com/baisebaoma/baiduqianxi):** 实习期间写的百度迁徙数据爬取工具，获得了 **50+ Stars**。
    * 最让我高兴的是收到邮件反馈，得知它帮助了**数十位博士生和科研人员**获取数据并推进了他们的研究进度！
* 🏫 **[SurviveGTSIManual](https://github.com/baisebaoma/SurviveGTSIManual):** GTSI 申请指南与生存手册。
    * 配合我的知乎万字回答（该话题下**最高赞**，拥有**近十万次阅读**），累计帮助了数百位同学做出择校决定。
...
* 🎮 **游戏与设计:**
    ...
    * **音游:** 曾经是 *Cytus II* & *Muse Dash* 玩家。虽然现在玩得少了，但那段经历激发了我想要自己开发音游的想法！
    * **MOBA:** 《英雄联盟》老玩家。
* 🎵 **音乐:** 偶尔会用 MIDI 键盘编曲自娱自乐。

### 🛠️ 历史遗迹与小工具

我写过很多解决自己特定需求的小工具（虽然有些已经不再维护了）：

* 🚫 **[LOLBlocker](https://github.com/baisebaoma/LOLBlocker):** 多年前为了戒除《英雄联盟》网瘾写的工具（显然，它失败了，我还在玩）。
* 🎮 **游戏工具:**
    * **[GenshinAccountSwitcher](https://github.com/baisebaoma/GenshinAccountSwitcher):** 自助原神切号器。
    * **[LOL-OB-Tools](https://github.com/baisebaoma/LOL-OB-Tools):** (Deprecated) 远古时期的观战工具。
    * **[freekill-selfservice-updater](https://github.com/baisebaoma/freekill-selfservice-updater):** (Deprecated) 帮助开发者自助更新《新月杀》服务器包的简单网页工具。
...
* 🔠 **语言:** 普通话, 英语, 粤语. (欢迎使用任意语言联系我，我会使用翻译软件！)
* 📫 **Email:** baisebaoma@foxmail.com
* 👔 **LinkedIn:** [baisebaoma](https://www.linkedin.com/in/baisebaoma/)
...
I take great pride in helping others through my code, whether they are researchers or students:

* 🕷️ **[baiduqianxi](https://github.com/baisebaoma/baiduqianxi):** A crawler for Baidu Migration data written during my internship (50+ Stars).
    * I was thrilled to receive emails confirming that it helped **dozens of PhD students and researchers** with their data collection!
* 🏫 **[SurviveGTSIManual](https://github.com/baisebaoma/SurviveGTSIManual):** GTSI Application & Survival Guide.
    * Accompanied by my 10k-word Zhihu article—the **most upvoted** answer with **nearly 100,000 views**—which has helped hundreds of students with their college decisions.
...
* 🎮 **Gaming & Game Design:**
    ...
    * **Rhythm Games:** Retired player of *Cytus II* & *Muse Dash*. That experience inspired my own rhythm game project!
    * **MOBA:** Long-time *League of Legends* player.
* 🎵 **Music:** Occasionally composing music with a MIDI keyboard for fun.

### 🛠️ Legacy Tools

I've built many small tools to solve my own problems—even if some are now deprecated:

* 🚫 **[LOLBlocker](https://github.com/baisebaoma/LOLBlocker):** A tool written years ago to cure my LoL addiction. *Spoiler: It failed. I still play.*
* 🎮 **Game Tools:**
    * **[GenshinAccountSwitcher](https://github.com/baisebaoma/GenshinAccountSwitcher):** Genshin Impact Account Switcher.
    * **[LOL-OB-Tools](https://github.com/baisebaoma/LOL-OB-Tools):** (Deprecated) Old spectating tools.
    * **[freekill-selfservice-updater](https://github.com/baisebaoma/freekill-selfservice-updater):** (Deprecated) A simple web tool for updating private game server packages.
...
* 🔠 **Languages:** Chinese, English, Cantonese. (*Feel free to contact me in any language—I can handle it with translation tools!*)
* 📫 **Email:** baisebaoma@foxmail.com
* 👔 **LinkedIn:** [baisebaoma](https://www.linkedin.com/in/baisebaoma/)
...
*If you have any suggestions or find bugs in my repos, please feel free to open an issue!*
